<template>
    <v-container class="-arrow-buffer-top -arrow-buffer-bot">
        ...
        <p>
            At ICRAFT, accessible from www.icraft.co.nz, one of our main priorities is the privacy of our visitors. This
            Privacy Policy document contains types of information that is collected and recorded by ICRAFT and how we
            use it.
        </p>
        <p>
            If you have additional questions or require more information about our Privacy Policy, do not hesitate to
            contact us through email at josh@icraft.co.nz
        </p>
        <p>
            Log Files<br/>
            ICRAFT follows a standard procedure of using log files. These files log visitors when they visit websites.
        ...
        <p>
            ...
            Like any other website, ICRAFT uses 'cookies'. These cookies are used to store information including
        ...
        <p>
            Privacy Policies<br/>
            You may consult this list to find the Privacy Policy for each of the advertising partners of ICRAFT. Our
            Privacy Policy was created with the help of the GDPR Privacy Policy Generator and the Terms and Conditions
            Template.
        </p>
        <p>
            Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on ICRAFT, which are sent directly to users'
        ...
        <p>
            Note that ICRAFT has no access to or control over these cookies that are used by third-party advertisers.
        </p>
        <p>
            Third Pary Privacy Policies<br/>
            ICRAFT's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            complete list of these Privacy Policies and their links here: Privacy Policy Links.
        </p>
        <p>
        ...
        <p>
            ICRAFT does not knowingly collect any Personal Identifiable Information from children under the age of 13.
        ...
        <p>
            ...
            regards to the information that they shared and/or collect in ICRAFT. This policy is not applicable to any
